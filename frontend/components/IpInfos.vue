...
import { getIPFromIPIP, getIPFromCloudflare_V4, getIPFromCloudflare_V6, getIPFromAmazon, getIPFromIdentMe_V4, getIPFromIdentMe_V6 } from '@/utils/getips';
...
const ipDataCards = reactive([
  ...
  },
  {
    ...createDefaultCard(),
    id: "identme_v4",
    source: "ident.me IPv4",
  },
  {
    ...createDefaultCard(),
    id: "identme_v6",
    source: "ident.me IPv6",
  },
]);
...
const checkAllIPs = async () => {
  const ipFunctions = [
    ...
    () => fetchIP(3, getIPFromAmazon),
    () => fetchIP(4, getIPFromIdentMe_V4),
    () => fetchIP(5, getIPFromIdentMe_V6),
  ];
